...
if [ "$(check_installed strip)" == "true" ]; then
    strip dist-newstyle/build/x86_64-linux/ghc-8.8.4/MonType-0.1.0.0/x/MonType/opt/build/MonType/MonType
else
...
if [ "$(check_installed upx)" == "true" ]; then
    rm -f montype
    upx -9 dist-newstyle/build/x86_64-linux/ghc-8.8.4/MonType-0.1.0.0/x/MonType/opt/build/MonType/MonType -o montype
    ...
    cp dist-newstyle/build/x86_64-linux/ghc-8.8.4/MonType-0.1.0.0/x/MonType/opt/build/MonType/MonType montype
